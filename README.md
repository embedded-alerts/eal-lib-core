...
Canonical Embedded Alerts persistence contracts, ORM-generation inventory, opaque
...
contracts remain in [embedded-alerts/eal-interfaces](https://github.com/embedded-alerts/eal-interfaces);
...
- Zed dependencies on embedded-alerts/eal-interfaces,
...
DDL belongs to a serialized one-shot job using `eal__migrator`; normal
