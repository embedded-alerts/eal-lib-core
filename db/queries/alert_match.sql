...
-- Alert matching for eal.page_embeddings: which saved alert rules does a newly ingested row fire?
...
rule_candidates as (
  select r.id
    from eal.page_embeddings r, doc
...
select r.id as rule_id,
  ...
  join eal.page_embeddings r on r.id = c.id
  cross join doc
