...
-- Hybrid retrieval over eal.page_embeddings: lexical + vector, fused by reciprocal rank.
...
vector_candidates as (
  select e.id,
    ...
    from eal.page_embeddings e, scope s
...
select e.id,
  ...
  from fused f
  join eal.page_embeddings e on e.id = f.id
