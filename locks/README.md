...
Lock routines for **embedded-alerts**, wrapping
...
| Path | Package |
| --- | --- |
| `rust` | `eal-locks` crate |
| `typescript` | `@embedded-alerts/locks` |
| `dart` | `eal_locks` |
| `gleam` | `eal_locks` |
| `golang` | `github.com/embedded-alerts/eal-lib-core/locks/golang` |

Every key this org locks is `embedded-alerts/<domain>/<name>`; the prefix is applied
