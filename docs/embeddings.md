...
Table: `eal.page_embeddings` · tenant column: `workspace_id` · owning repo: this one.
...
scoped by `(workspace_id, model_key)`, and `eal_emb_one_row_per_entity_per_model`
