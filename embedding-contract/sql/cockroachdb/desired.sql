-- EmbeddedAlerts embedding contract v2 (CockroachDB)
...
UPSERT INTO embedded_alerts.embedding_model_profiles
...
CREATE TABLE IF NOT EXISTS embedded_alerts.semantic_embeddings (
  ...
  purpose STRING NOT NULL CHECK (purpose IN ('webpage_search', 'change_correlation', 'alert')),
  embedding_provider STRING NOT NULL,
...
CREATE VECTOR INDEX semantic_embeddings_ann_idx
  ON embedded_alerts.semantic_embeddings (tenant_id, embedding_space, purpose, embedding);
