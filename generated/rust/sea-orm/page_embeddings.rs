...
//
// SeaORM entity for eal.page_embeddings. SeaORM is the application ORM for this fleet; direct
...
#[sea_orm(schema_name = "eal", table_name = "page_embeddings")]
pub struct Model {
...
/// One registry entry, mirroring `eal.embedding_models`.
